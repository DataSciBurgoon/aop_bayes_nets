...
bn_test <- grain(plist)
png("steatosis_bn.png", height=6000, width=6000, res=300, pointsize=20)
plot(bn_test)
dev.off()
querygrain(setEvidence(bn_test, evidence=list(fatty_acid_beta_oxidation="no")))
querygrain(setEvidence(bn_test, evidence=list(cytosolic_fatty_acids="yes")))
